...
bool rdk_ai_gateway_msg__srv__text_to_text__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rdk_ai_gateway_msg.srv._text_to_text.TextToText_Request", full_classname_dest, 55) == 0);
  }
  rdk_ai_gateway_msg__srv__TextToText_Request * ros_message = _ros_message;
  {  // input
...
{
  /* NOTE(esteve): Call constructor of TextToText_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rdk_ai_gateway_msg.srv._text_to_text");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TextToText_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool rdk_ai_gateway_msg__srv__text_to_text__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rdk_ai_gateway_msg.srv._text_to_text.TextToText_Response", full_classname_dest, 56) == 0);
  }
  rdk_ai_gateway_msg__srv__TextToText_Response * ros_message = _ros_message;
  {  // output
...
{
  /* NOTE(esteve): Call constructor of TextToText_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rdk_ai_gateway_msg.srv._text_to_text");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TextToText_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
